<?php 
	...
	if (isset($_POST['edit']) && $_POST['_action_'] == 'TRUE') {
		$query  = "UPDATE contact SET firstname='" . $_POST['firstname'] . "', lastname='" . $_POST['lastname'] . "', email='" . $_POST['email'] . "', username='" . $_POST['username'] . "', country='" . $_POST['country'] . "', archive='" . $_POST['archive'] . "'";
	...
	#Edit user profile
		...
		<form action="" id="registration_form" name="registration_form" method="POST">
			...
			<input type="text" id="username" name="username" value="' . $row['username'] . '" pattern=".{6,12}" placeholder="Username.." required><br>
            ...
            <input type="radio" name="archive" value="Y"'; if($row['archive'] == '1') { echo ' checked="checked"'; $checked_archive = true; } echo ' /> YES &nbsp;&nbsp;
			...
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					...
					<tr>
						...
						<td>';
							if ($row['archive'] == '1') { print '<img src="img/inactive.png" alt="" title="" />'; }
                            else if ($row['archive'] == '0') { print '<img src="img/active.png" alt="" title="" />'; }
						print '
						</td>
					</tr>';
				}
